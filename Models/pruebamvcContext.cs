...
namespace pruebamvc.Models
{
    public class pruebamvcContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<pruebamvc.Models.pruebamvcContext>());

        public pruebamvcContext() : base("name=pruebamvcContext")
        {
        }

        public DbSet<personaModels> personas { get; set; }
    }
}
